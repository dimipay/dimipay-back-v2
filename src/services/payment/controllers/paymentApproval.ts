...
const calculateProductUnitPrice = (
  ...
  if (
    product.targettedDiscountPolicy &&
    product.targettedDiscountPolicy.length > 0
  ) {
    ...
    product.excludedDiscountPolicy &&
    product.excludedDiscountPolicy.length > 0
  ) {
    return product.sellingPrice;
  } else if (
    product.category.discountPolicy &&
    product.category.discountPolicy.length > 0
  ) {
    return calculatedPrice(
      product.sellingPrice,
